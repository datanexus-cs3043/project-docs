...
| **[Development Workflow](development_workflow.md)** | Local setup, Docker execution, Git branching, and Conventional Commits. |
...
2. **Review Process**: Any changes to system specifications or architectural rules must be submitted via Pull Request for team review.
